...
// 👑 Même taille (14px) que les autres icônes de boutons voisins, pour la
// même raison : éviter le moindre écart de hauteur entre libellés.
function iconeColis(): string {
  return `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4a2 2 0 0 0 1-1.73Z"></path><path d="m3.3 7 8.7 5 8.7-5"></path><path d="M12 22V12"></path></svg>`;
}
...
export function toggleModePanierRetour(): void {
  ...
  if (btn) {
    if (modePanierRetour) {
      ...
      btn.classList.remove("active");
      btn.innerHTML = `<span style="display:inline-flex; align-items:center; gap:7px;">${iconeColis()}Mode Retour Groupé</span>`;
      document.getElementById("floating-panier")?.classList.add("hidden");
    }
  }
  renderItems();
